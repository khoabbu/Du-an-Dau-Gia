                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="footer">
                                ...
                                <img src={{asset('client/images/logo/logo-do-cocaybuado.png')}}>
                                <div class="ft__details">
                                    <p>
                                        Cung cấp nền tảng đấu giá trực tuyến cho bạn
                                    </p>
                                    <div class="ft__social__link">
                                        <ul class="social__link">
                                            ...
                                            <li><a href="https://www.instagram.com/"><i class="icon-social-facebook icons"></i></a></li>
                                            ...
                                            <li><a href="https://www.youtube.com/"><i class="icon-social-youtube icons"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
